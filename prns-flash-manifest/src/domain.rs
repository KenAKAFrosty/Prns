...
pub use target::{
    ApplicationAddressRange, EspFlashPart, EspSerialTarget, NrfSerialDfuArtifact,
    NrfSerialDfuRecovery, NrfSerialDfuTarget, ReleasePartRef, ReleaseTarget, SoftdeviceFamily,
