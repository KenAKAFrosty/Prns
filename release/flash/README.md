...
- assign the twelve physical, three Firefox Web Serial, one Safari fallback, and five
...
- validates fourteen full transport-aware physical rows, three Firefox Web Serial smokes, one Safari
