...
#define PRNS_HOST_SCHEMA_VERSION UINT32_C(2)
...
#define PRNS_COMMAND_FAILURE_KIND_LINK_CLOSED UINT32_C(42)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_CANCELLED_BY_SENDER UINT32_C(43)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_HASHMAP_BEYOND_PART_COUNT UINT32_C(44)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_HASHMAP_SKIPS_AHEAD UINT32_C(45)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_HASHMAP_TOO_LONG UINT32_C(46)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_HASHMAP_RAGGED UINT32_C(47)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_RETRIES_EXHAUSTED UINT32_C(48)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_LINK_VANISHED UINT32_C(49)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_TRANSFER_UNOPENABLE UINT32_C(50)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_TRANSFER_CORRUPT UINT32_C(51)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_PROOF_UNSENDABLE UINT32_C(52)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_DECOMPRESSION_FAILED UINT32_C(53)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_DECOMPRESSION_TIMED_OUT UINT32_C(54)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_OPEN_TIMED_OUT UINT32_C(55)
#define PRNS_COMMAND_FAILURE_KIND_RESPONSE_METADATA_OVERRUN UINT32_C(56)
...
#define PRNS_LINK_CLOSED_REASON_LOCALLY_CLOSED UINT32_C(4)
...
#define PRNS_EVENT_FIELD_LOCAL_DESTINATION UINT32_C(41)
#define PRNS_EVENT_FIELD_ARRIVED_AT_MILLIS UINT32_C(42)
