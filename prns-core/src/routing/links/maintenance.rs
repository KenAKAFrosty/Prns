...
impl<S: StorageLayout> EngineState<S> {
    ...
    /// Seal the LINKCLOSE the way RNS 1.4.0 `Link.teardown` does (the link_id  encrypted under the session key) then forget the link; the dropped row zeroizes its key material.
