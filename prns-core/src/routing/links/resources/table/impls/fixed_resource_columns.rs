...
/// Inline columns for a no_std target: every byte the slots can hold lives
...
#[derive(Debug)]
pub struct FixedResourceColumns<
    State,
    const SLOTS: usize,
...
impl<State: Default, const SLOTS: usize, const TRANSFER_BYTES: usize, const MAX_PARTS: usize>
    Default for FixedResourceColumns<State, SLOTS, TRANSFER_BYTES, MAX_PARTS>
{
    fn default() -> Self {
        const {
            assert!(
...
impl<State: Default, const SLOTS: usize, const TRANSFER_BYTES: usize, const MAX_PARTS: usize>
    ResourceColumns<State> for FixedResourceColumns<State, SLOTS, TRANSFER_BYTES, MAX_PARTS>
{
