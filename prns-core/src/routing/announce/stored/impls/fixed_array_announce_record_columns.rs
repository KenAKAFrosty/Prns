...
pub struct FixedArrayAnnounceRecordColumns<const MAX_TRACKED_DESTINATIONS: usize> {
    len: usize,
...
impl<const MAX_TRACKED_DESTINATIONS: usize> Default
    for FixedArrayAnnounceRecordColumns<MAX_TRACKED_DESTINATIONS>
{
    fn default() -> Self {
        Self {
            len: 0,
...
impl<const MAX_TRACKED_DESTINATIONS: usize> AnnounceRecordColumns
    for FixedArrayAnnounceRecordColumns<MAX_TRACKED_DESTINATIONS>
{
