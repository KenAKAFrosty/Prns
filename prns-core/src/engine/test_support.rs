...
/// The parity vectors were originally minted with RNS 1.3.5 and revalidated against RNS 1.4.0.
...
/// b"hello-personal"), generated with RNS 1.3.5 and revalidated live against RNS 1.4.0.
pub const RNS_1_4_0_ANNOUNCE: &str = "010016f8a6d3f7d7c5b6f106d293804d73140002281f6d21232cbba9d12e516183197f08e\
...
pub fn rns_1_4_0_announce_accepted(hops: u8) -> IngestPacketOutcome<'static> {
...
/// The fixed identity's ratcheted announce; [`RNS_1_4_0_RETRANSMITTED_ANNOUNCE`] is the reference's own retransmission of it and [`RNS_1_4_0_SEALED_TO_RATCHET`] seals to its ratchet.
pub const RNS_1_4_0_RATCHETED_ANNOUNCE: &str = "2100c3cfae69b36bb6e3bbfd96a3b5867a5900\
...
/// The reference's own retransmission of [`RNS_1_4_0_RATCHETED_ANNOUNCE`]: minted by
/// RNS 1.3.5 `Transport.jobs()` packet construction (`HEADER_2`, `TRANSPORT`, transport_id
/// `0x7A…` = [`TEST_TRANSPORT_ID`], hops 1), revalidated with RNS 1.4.0, and self-checked
/// through `Identity.validate_announce` before pinning.
pub const RNS_1_4_0_RETRANSMITTED_ANNOUNCE: &str =
...
/// A single sealed to [`personal_node_destination`] under the pinned test entropy; RNS 1.4.0 answered it with [`RNS_1_4_0_IMPLICIT_PROOF`].
pub const RNS_1_4_0_SEALED_FOR_PROOF: &str =
...
/// The reference's own implicit proof answering [`RNS_1_4_0_SEALED_FOR_PROOF`]; our `write_proof` reproduces it byte-identically.
pub const RNS_1_4_0_IMPLICIT_PROOF: &str =
...
/// A single sealed to [`RNS_1_4_0_RATCHETED_ANNOUNCE`]'s ratchet; our writer reproduces it byte-identically under the pinned vector entropy.
pub const RNS_1_4_0_SEALED_TO_RATCHET: &str =
    "0000c3cfae69b36bb6e3bbfd96a3b5867a59007b0d47d93427f8311160781c7c733fd89f88970aef490d8a\
...
/// [`RNS_1_4_0_SEALED_TO_RATCHET`] as RNS 1.4.0 `Transport.outbound` injects it into transport for a multi-hop destination: `HEADER_2`/`TRANSPORT` flags spliced in, addressed at the relay `0x7A…` ([`TEST_TRANSPORT_ID`]), hops untouched.
...
pub const RNS_1_4_0_SEALED_TO_RATCHET_VIA_TRANSPORT: &str =
