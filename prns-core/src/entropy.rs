...
const RESEED_INFO: &[u8] = b"prns/csprng/reseed/v1";
...
mod tests {
    ...
    fn reseed_transcript_and_next_output_match_the_v1_golden_vector() {
        ...
        let expected_seed = [
            0xcf, 0xf9, 0xcf, 0x3d, 0x5f, 0x29, 0x87, 0x65, 0xae, 0x4c, 0xe9, 0x6d, 0x5e, 0x65,
            0xb6, 0xa7, 0x68, 0x06, 0x39, 0xa7, 0x3c, 0x0e, 0xc1, 0x29, 0x90, 0x1d, 0x25, 0x1d,
            0xac, 0x1e, 0xe6, 0x52,
        ];
        ...
        let expected_output = [
            0xf0, 0x6b, 0x8c, 0x02, 0x87, 0x06, 0x22, 0xa8, 0x99, 0xca, 0x2d, 0xda, 0xbc, 0x32,
            0x4d, 0x4a, 0x8f, 0x15, 0x6d, 0xfe, 0x66, 0x24, 0xa2, 0x52, 0xba, 0x49, 0x1a, 0x1a,
            0xe7, 0xcd, 0x94, 0x44, 0x14, 0xcd, 0x40, 0x1d, 0xea, 0x81, 0x04, 0x09, 0x70, 0xb9,
            0x63, 0x4b, 0x89, 0x36, 0x5e, 0x07, 0x6e, 0x4a, 0xda, 0xae, 0xf8, 0x17, 0x81, 0x7f,
            0xd4, 0xb9, 0x98, 0xe3, 0x61, 0x5c, 0x70, 0x0d,
        ];
