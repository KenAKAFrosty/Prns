...
Its paved application SDKs are currently [Rust](personal-rns/README.md) and
[TypeScript / JavaScript](prns-js/README.md), including browsers, Node.js,
and Bun.

Prns also has source-ready SDK previews for
...
[Julia](prns-host/bindings/julia/README.md), and
[C and C++](prns-host/abi/c/README.md). These are real adapters over the same
native Rust engine, with generated types and live conformance tests. Their
idiomatic registry packaging and native artifact delivery are active release
work. Experienced developers in those ecosystems can make an especially
valuable contribution to Prns by helping refine the consumer API, as well as platform/packaging structure.
