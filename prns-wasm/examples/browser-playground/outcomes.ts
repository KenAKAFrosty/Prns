...
export function describeStartupFailure(outcome: StartupFailure): string {
  return match_into<string>().from(outcome, {
    ...
    WorkerStartFailed: ({ detail }) => `Worker start: ${detail}`,
    WorkerProtocolFailed: ({ detail }) => `Worker protocol: ${detail}`,
...
export function describeCommandFailure(outcome: CommandFailure): string {
  return match_into<string>().from(outcome, {
    ...
    LinkClosed: () => "The link closed before the operation completed",
    ResponseCancelledBySender: () => "The response was cancelled by its sender",
    ResponseHashmapBeyondPartCount: () => "The response hashmap exceeds its part count",
    ResponseHashmapSkipsAhead: () => "The response hashmap skips ahead",
    ResponseHashmapTooLong: () => "The response hashmap is too long",
    ResponseHashmapRagged: () => "The response hashmap is ragged",
    ResponseRetriesExhausted: () => "Response transfer retries were exhausted",
    ResponseLinkVanished: () => "The response link vanished",
    ResponseTransferUnopenable: () => "The response transfer could not be opened",
    ResponseTransferCorrupt: () => "The response transfer is corrupt",
    ResponseProofUnsendable: () => "The response proof could not be sent",
    ResponseDecompressionFailed: () => "Response decompression failed",
    ResponseDecompressionTimedOut: () => "Response decompression timed out",
    ResponseOpenTimedOut: () => "Opening the response timed out",
    ResponseMetadataOverrun: () => "The response metadata exceeds its declared bounds",
