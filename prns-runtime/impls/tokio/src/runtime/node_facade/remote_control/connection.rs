...
use crate::runtime::{
    ...
    RemoteControlInventoryInterfaces, RemoteControlInventoryPathTable, RemoteControlSleepRadios,
...
use prns_core::remote_control::{
    ...
    RemoteControlLoRaProfile, RemoteControlModeOutcome, RemoteControlPathInventory,
