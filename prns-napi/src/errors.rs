...
impl AsRef<str> for ErrorCode {
    fn as_ref(&self) -> &str {
        match self {
            ...
            Self::LinkClosed => "PRNS_LINK_CLOSED",
            Self::ResponseCancelledBySender => "PRNS_RESPONSE_CANCELLED_BY_SENDER",
            Self::ResponseHashmapBeyondPartCount => "PRNS_RESPONSE_HASHMAP_BEYOND_PART_COUNT",
            Self::ResponseHashmapSkipsAhead => "PRNS_RESPONSE_HASHMAP_SKIPS_AHEAD",
            Self::ResponseHashmapTooLong => "PRNS_RESPONSE_HASHMAP_TOO_LONG",
            Self::ResponseHashmapRagged => "PRNS_RESPONSE_HASHMAP_RAGGED",
            Self::ResponseRetriesExhausted => "PRNS_RESPONSE_RETRIES_EXHAUSTED",
            Self::ResponseLinkVanished => "PRNS_RESPONSE_LINK_VANISHED",
            Self::ResponseTransferUnopenable => "PRNS_RESPONSE_TRANSFER_UNOPENABLE",
            Self::ResponseTransferCorrupt => "PRNS_RESPONSE_TRANSFER_CORRUPT",
            Self::ResponseProofUnsendable => "PRNS_RESPONSE_PROOF_UNSENDABLE",
            Self::ResponseDecompressionFailed => "PRNS_RESPONSE_DECOMPRESSION_FAILED",
            Self::ResponseDecompressionTimedOut => "PRNS_RESPONSE_DECOMPRESSION_TIMED_OUT",
            Self::ResponseOpenTimedOut => "PRNS_RESPONSE_OPEN_TIMED_OUT",
            Self::ResponseMetadataOverrun => "PRNS_RESPONSE_METADATA_OVERRUN",
