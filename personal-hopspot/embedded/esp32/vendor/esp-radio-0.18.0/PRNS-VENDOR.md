...
- Local changes:
  ...
  - Expose the ESP-IDF PMF-required setting for station and SoftAP configurations and select SAE's
    interoperable Hunt-and-Peck plus Hash-to-Element mode instead of leaving SoftAP SAE unspecified.
