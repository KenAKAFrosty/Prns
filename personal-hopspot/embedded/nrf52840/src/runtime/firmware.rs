...
use personal_rns::interfaces::lora::{AirtimePolicy, boot_lora_profile};
...
pub async fn run(spawner: Spawner) -> ! {
    ...
    let loaded_lora_profile = match lora_profile_store.load(boot_lora_profile(MAX_TX_POWER_DBM)).await {
