...
impl T114Storage {
    ...
    const REQUEST_HANDLERS: usize =
        <personal_hopspot_core::node_pages::NodePageRoutes as RequestEndpointSet<()>>::REGISTRATIONS
            .len();
    pub(crate) const LINK_SESSIONS: usize = 32;
    ...
    pub(crate) const MAX_OUTGOING_RESOURCE_REACTION_FRAMES: usize =
...
const _: () = assert!(T114Storage::LINK_SESSIONS > T114Storage::CHANNELS);
const _: () = assert!(T114Storage::RESOURCE_ASSEMBLIES == 1);

impl StorageLayout for T114Storage {
