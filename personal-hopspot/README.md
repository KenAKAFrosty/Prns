...
The headless T1000-E and Seeed SenseCAP Solar Node build the same way. Having no
button or screen, both announce their node page 15 seconds after boot and every
six hours. The Solar Node runs bare-metal beside its resident S140 7.3.0 and
defaults to the EU869 "g3" sub-band (869.4625 MHz, 125 kHz, SF8, 10 % duty
cycle), the channel the public EU gateways on rmap.world share:
