...
pub use flash_layout::{
    ...
    HEADLESS_NRF52840_MIN_ARENA_BYTES, HOPSPOT_FLASH_PAGE_BYTES,
    ...
    T096_APPLICATION_DATA_END, T096_FACTORY_RESERVED_FLASH_OFFSET, T096_FIRMWARE_MEMORY,
    T096_JOURNAL_LAYOUT, T096_RECOVERY_BOOTLOADER_FLASH_OFFSET, T1000E_JOURNAL_LAYOUT,
    T114_FIRMWARE_MEMORY, T114_RECOVERY_BOOTLOADER_FLASH_OFFSET, T_ECHO_JOURNAL_LAYOUT,
