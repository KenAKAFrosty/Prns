...
pub use flash_layout::{
    ...
    ESP32_4_MIB_REMOTE_CONTROL_IDENTITY_FLASH_OFFSET, HELTEC_DISPLAY_NRF52840_JOURNAL_LAYOUT,
    HELTEC_DISPLAY_REMOTE_CONTROL_IDENTITY_FLASH_OFFSET, HOPSPOT_FLASH_PAGE_BYTES,
    MESH_TOWER_V2_BLE_IDENTITY_FLASH_OFFSET, MESH_TOWER_V2_JOURNAL_LAYOUT,
    ...
    T1000E_JOURNAL_LAYOUT, T1000E_NODE_IDENTITY_FLASH_OFFSET,
