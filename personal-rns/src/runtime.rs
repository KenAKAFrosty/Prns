...
pub use prns_runtime_embassy::runtime::{
    ...
    InterfaceLane, LaneClaimError, OutboundFrame, PoolTakeError, PrnsNode, PrnsNodeHandle,
...
pub use prns_runtime_embassy::runtime::{
    ...
    LaneClaimError, OutboundFrame, PoolTakeError, PrnsNode as EmbassyPrnsNode,
