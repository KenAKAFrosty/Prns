...
use crate::interfaces::rns_parity::rnode::core::{self, RadioConfig};
...
/// This is RNode's analogue of the generic [`framed_stream::serve`](crate::interfaces::framed_stream)
...
impl<Open> crate::interfaces::ReportsStatus for RNodeInterface<Open> {
...
mod tests {
    use super::*;
    use crate::interfaces::kiss_framing::{self, FEND};
