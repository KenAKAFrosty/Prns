...
use crate::interfaces::rns_parity::websocket::{core, tokio_wire};
...
impl crate::interfaces::ReportsStatus for WebSocketServer {
...
impl<S> crate::interfaces::ReportsStatus for WebSocketServerConnection<S> {
    fn status_view(&self) -> Option<crate::interfaces::StatusView> {
