...
pub trait InterfacePathRequestLimitColumns {
...
pub struct InterfacePathRequestLimits<C: InterfacePathRequestLimitColumns> {
    columns: C,
}
...
impl<C: InterfacePathRequestLimitColumns> InterfacePathRequestLimits<C> {
    ...
    fn index_or_insert(&mut self, interface: InterfaceId, now: InstantMillis) -> usize {
        ...
        self.columns.push(InterfacePathRequestLimit {
            interface,
            created_at: now,
            window_start: now,
            window_count: 0,
...
mod tests {
    ...
    fn limits() -> InterfacePathRequestLimits<FixedInterfacePathRequestLimitColumns<4>> {
