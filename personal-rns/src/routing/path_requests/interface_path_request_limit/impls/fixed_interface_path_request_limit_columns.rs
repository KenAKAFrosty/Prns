...
use crate::routing::path_requests::interface_path_request_limit::{
    BurstState, InterfacePathRequestLimit, InterfacePathRequestLimitColumns,
};

#[derive(Debug)]
pub struct FixedInterfacePathRequestLimitColumns<const MAX_INTERFACES: usize> {
    len: usize,
    rows: [InterfacePathRequestLimit; MAX_INTERFACES],
}

impl<const MAX_INTERFACES: usize> Default
    for FixedInterfacePathRequestLimitColumns<MAX_INTERFACES>
{
    fn default() -> Self {
        Self {
            len: 0,
...
impl<const MAX_INTERFACES: usize> InterfacePathRequestLimitColumns
    for FixedInterfacePathRequestLimitColumns<MAX_INTERFACES>
{
