...
#[derive(Debug)]
pub struct FixedRecentPathRequestColumns<const MAX_RECENT_PATH_REQUESTS: usize> {
    len: usize,
...
impl<const MAX_RECENT_PATH_REQUESTS: usize> Default
    for FixedRecentPathRequestColumns<MAX_RECENT_PATH_REQUESTS>
{
    fn default() -> Self {
        Self {
            len: 0,
...
impl<const MAX_RECENT_PATH_REQUESTS: usize> RecentPathRequestColumns
    for FixedRecentPathRequestColumns<MAX_RECENT_PATH_REQUESTS>
{
