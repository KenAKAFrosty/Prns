...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleSetPsm(
    _env: JNIEnv,
    _class: JClass,
    psm: jint,
) {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleDesiredState(
    _env: JNIEnv,
    _class: JClass,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBlePeerCapacity(
    _env: JNIEnv,
    _class: JClass,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleWorkGeneration(
    _env: JNIEnv,
    _class: JClass,
) -> jlong {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleWaitForWork(
    _env: JNIEnv,
    _class: JClass,
    observed: jlong,
...
fn bounded_work_wait_millis(requested: jlong) -> u64 {
    // Kotlin uses zero for upstream's indefinite idle wait. Keep the platform's one-second
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleWakePumps(
    _env: JNIEnv,
    _class: JClass,
) {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleIdentity(
    env: JNIEnv,
    _class: JClass,
    buffer: JByteBuffer,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleSighting(
    env: JNIEnv,
    _class: JClass,
    address: JByteBuffer,
    rssi: jint,
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleDialFailed(
    env: JNIEnv,
    _class: JClass,
    address: JByteBuffer,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleLinkUp(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    address: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleColumbaLinkUp(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    address: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleControlIn(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleControlOut(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleCommitControlOut(
    _env: JNIEnv,
    _class: JClass,
    conn_id: jint,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleL2capIn(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleL2capOut(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleDataIn(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleDataOut(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleCommitDataOut(
    _env: JNIEnv,
    _class: JClass,
    conn_id: jint,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleL2capUp(
    _env: JNIEnv,
    _class: JClass,
    conn_id: jint,
) {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleDisconnected(
    _env: JNIEnv,
    _class: JClass,
    conn_id: jint,
) {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleNextClose(
    _env: JNIEnv,
    _class: JClass,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleNextDial(
    env: JNIEnv,
    _class: JClass,
    buffer: JByteBuffer,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_rs_reticulum_prns_expo_PrnsBluetoothNative_nativeBleNextL2capOpen(
    env: JNIEnv,
    _class: JClass,
    buffer: JByteBuffer,
) -> jboolean {
