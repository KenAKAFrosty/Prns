...
// BleLink.kt and NativeBridge.kt. This is Android transport glue for the shared
// Rust host, not a second Hopspot runtime. Retains the upstream dual license;
...
/** JNI transport endpoint for the selected shared Rust host image. */
object PrnsBluetoothNative {
    init {
        System.loadLibrary(PrnsNativeImage.name)
    }
