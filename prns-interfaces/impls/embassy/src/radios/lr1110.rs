...
// a per-chip event type. Re-exported here for import-path symmetry with sx126x.
...
/// `LoRaInterface` drives any `Radio`; the LR1110 is one such chip.
impl<SPI, BUSY, DIO1, RST, DLY> Radio for Lr1110<SPI, BUSY, DIO1, RST, DLY>
where
    SPI: SpiDevice,
    BUSY: Wait,
    DIO1: Wait,
