...
echo "PASS: Prnsd cp rejects partial publication, settles cancellation, and exchanges exact compressed, boundary, bulk, and completed multi-segment files with stock RNS rncp"
