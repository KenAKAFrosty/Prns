...
evidence. The bundle deduplicates exact license texts across the graph matrix, includes bundled
native-code notices, reproduces the Nordic terms, and appends the checked Android Maven and hosted
JavaScript closures. The browser graph pins
