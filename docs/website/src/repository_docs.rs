...
pub const GUIDE_DOCUMENTS: &[RepositoryDocument] = &[
    ...
    RepositoryDocument {
        ...
        source: include_str!("../../examples.md"),
    },
    RepositoryDocument {
        slug: "application-integration",
        title: "Application Integration",
        summary: "Own long-lived nodes, event streams, cancellation, permissions, and shutdown.",
        section: GuideSection::Start,
        source_path: "docs/application-integration.md",
        source: include_str!("../../application-integration.md"),
    },
    RepositoryDocument {
        slug: "embedded",
        title: "Embedded Prns",
...
const ROUTE_MAPPINGS: &[(&str, &str)] = &[
    ...
    (
        ...
        "/guides/application-integration",
    ),
