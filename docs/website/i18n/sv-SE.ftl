...
crate-rnsd-blurb = En drop-in för rnsd på macOS, Linux och Windows. Samma wire som RNS-referensen; använd den bredvid eller istället för noderna du redan har.
