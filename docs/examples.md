...
| --- | --- | --- |
| [`node_basics.rs`](../personal-rns/examples/node_basics.rs) | Runnable | Two localhost nodes exchange a real announce; `cargo tools guide rust-basics` is the Rust quickstart. |
