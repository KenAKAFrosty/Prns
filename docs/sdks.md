...
Prns 0.3.4 was the first publicly announced prerelease. The current 0.3.5 immutable GitHub release artifacts and exact source commit are authoritative for its candidate bytes. Registry packages become authoritative only after their independent publication qualification completes.
...
To use the exact source behind the public 0.3.5 prerelease before registry qualification completes:
