Archived September 9, 2026 from documentation at `31532838b`. This is a
historical record, not current setup or qualification guidance. Earlier uses of
“current” refer to their recorded checkpoint. The original chronology and negative
evidence are retained below; relative links were adjusted for this location.
See [current validation and limits](../docs/validation.md).
...
lifecycle matrix. See [Android development](../docs/android.md)
