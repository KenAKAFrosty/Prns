...
export const screenCatalog = [
  ...
  },
  {
    ...
    limitation: "Identities, interfaces, notifications, and activity remain labelled placeholders.",
    backPath: "/more",
    params: noParams,
    phoneRootOrder: 4,
    wideRootOrder: 4,
  ...
  },
  {
    ...
    deepLink: "external-navigation",
    availability: "implementedScaffold",
    summary: "See the development app identity, implemented iOS capabilities, and honest limits.",
    limitation:
  ...
  },
  {
    ...
    deepLink: "external-navigation",
    availability: "implementedScaffold",
    summary: "Understand the implemented iOS capabilities and remaining placeholder routes.",
