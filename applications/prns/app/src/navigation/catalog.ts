...
export const screenCatalog = [
  {
    ...
    summary: "Preview the create or import path with clearly synthetic development fixtures.",
    limitation: "No Installation or Reticulum identity is created by this scaffold.",
  ...
  },
  {
    ...
    summary: "Inspect and recover a retained installation.",
    limitation: "Scaffold data is disposable and has no retained Installation to recover.",
    backPath: "/onboarding/welcome",
  ...
  },
  {
    ...
    limitation: "No generated message record or delivery evidence exists yet.",
    backPath: "/inbox",
  ...
  },
  {
    ...
    deepLink: "external-navigation",
    availability: "notYetImplemented",
    summary: "Browse saved and observed destinations.",
    limitation: "The Rust-owned directory is not present in the scaffold.",
    backPath: "/contacts",
    params: noParams,
    phoneRootOrder: 1,
    wideRootOrder: 1,
  ...
  {
    id: "contacts.entry",
    path: "/contacts/:entryId",
    routeFiles: ["app/(shell)/contacts/[entryId].tsx"],
    label: "Contact",
    section: "contacts",
    ...
    deepLink: "external-navigation",
    availability: "notYetImplemented",
    summary: "Inspect a directory entry and its endpoints.",
    limitation: "No generated directory entry identifier or repository exists yet.",
    backPath: "/contacts",
    params: [{ kind: "scalar", name: "entryId", required: true }],
  },
  {
    id: "contacts.add",
    path: "/contacts/add",
    ...
    deepLink: "none",
    availability: "notYetImplemented",
    summary: "Save a deliberate directory contact.",
    limitation: "No directory mutation is available.",
    backPath: "/contacts",
    params: [
      {
        kind: "enum",
        name: "source",
        required: true,
        values: ["manual", "scan", "observed"],
      },
      { kind: "scalar", name: "observedDestination", required: false },
    ],
  },
  {
    id: "contacts.merge",
  ...
  },
  {
    ...
    deepLink: "external-navigation",
    availability: "implementedScaffold",
    summary: "Keep local and managed node contexts visibly distinct.",
    limitation: "Only a labelled E290 fixture preview is available.",
    backPath: "/nodes",
    params: noParams,
    phoneRootOrder: 2,
    wideRootOrder: 2,
  },
  {
    ...
    limitation: "The aggregate Rust Host has not been constructed.",
    backPath: "/nodes",
    params: noParams,
  },
  {
    ...
    deepLink: "external-navigation",
    availability: "implementedScaffold",
    summary: "Preview a managed-node workspace with its target always visible.",
    limitation: "The target is a fixture and no RemoteControl command is available.",
    backPath: "/nodes",
  ...
  },
  {
    ...
    deepLink: "none",
    availability: "notYetImplemented",
    summary: "Pair with an upstream RemoteControl target.",
    limitation: "Pairing needs the first native Rust and physical E290 slice.",
    backPath: "/nodes",
  ...
  },
  {
    ...
    limitation: "No local RemoteControl target is running.",
  ...
  },
  {
    ...
    limitation: "The scaffold creates no Reticulum identity material.",
    backPath: "/more",
    params: noParams,
  },
  {
  ...
  },
  {
    ...
    limitation: "No Host capability or generated interface projection exists.",
    backPath: "/more",
    params: noParams,
    wideRootOrder: 7,
  },
  {
    ...
    limitation: "No generated interface identifier or status is available.",
  ...
  },
  {
    ...
    limitation: "No Rust runtime or service contract is loaded.",
    backPath: "/more/settings",
    params: noParams,
  },
  {
