...
import rs.reticulum.prns.host.bindings.FfiConverterTypeHostClientHandle
import rs.reticulum.prns.host.bindings.FfiConverterTypeHostSnapshot
import rs.reticulum.prns.host.bindings.HostClientHandle
import rs.reticulum.prns.host.bindings.HostSnapshot
import rs.reticulum.prns.host.bindings.RustBuffer as RustBufferHostClientHandle
import rs.reticulum.prns.host.bindings.RustBuffer as RustBufferHostSnapshot
...
internal object UniffiLib {
    ...
    init {
        ...
        rs.reticulum.prns.host.bindings.uniffiEnsureInitialized()
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeHostClientHandle: FfiConverterRustBuffer<HostClientHandle?> {
    override fun read(buf: ByteBuffer): HostClientHandle? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeHostClientHandle.read(buf)
    }

    override fun allocationSize(value: HostClientHandle?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeHostClientHandle.allocationSize(value)
        }
    }
    ...
    override fun write(value: HostClientHandle?, buf: ByteBuffer) {
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypeHostClientHandle.write(value, buf)
        }
    }
}
...
public typealias FfiConverterTypeCanonicalHostSnapshot = FfiConverterTypeHostSnapshot
 ...
 fun `bindingContract`(): BindingContract {
    ...
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
     suspend fun `setContactPinned`(`input`: SetContactPinnedInput) : ContactMutationOutcome {
         ...
         */ fun `sharedHost`(): HostClientHandle? {
            return FfiConverterOptionalTypeHostClientHandle.lift(
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_prns_app_fn_func_shared_host(
