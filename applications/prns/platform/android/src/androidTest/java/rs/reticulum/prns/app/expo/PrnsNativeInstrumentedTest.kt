...
class PrnsNativeInstrumentedTest {
  ...
  fun generatedBindingsPreserveIdentityAndContactsAcrossNativeRestart() = runBlocking {
    withIsolatedRuntime("generated-identity") { root ->
      ...
      repeat(2) {
        assertTrue(PrnsBluetoothLifecycle.nativePrepareBluetooth())
        assertFalse(PrnsBluetoothLifecycle.nativePrepareBluetooth())
        ...
        assertFalse(PrnsBluetoothLifecycle.nativeReleaseBluetooth())
        ...
        assertTrue(PrnsBluetoothLifecycle.nativeReleaseBluetooth())
