...
class FlasherRollbackTests(unittest.TestCase):
    ...
    def test_workflows_fail_closed_for_history_and_rollback(self) -> None:
        ...
        self.assertIn("verify-historical-flasher-release.py", candidate)
        ...
        self.assertIn("verify-historical-flasher-release.py", promotion)
        ...
        historical = (ROOT / "scripts/verify-historical-flasher-release.py").read_text(
            encoding="utf-8"
        )
        self.assertLess(
            historical.index('"-Vm"'),
