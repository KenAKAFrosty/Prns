...
SERVER="$ROOT/prns-core/tests/interop/rns_rnprobe_server.py"
WORK="$(mktemp -d)"
CONFIG="$WORK/config"
...
echo "PASS: Prnsd probe exchanged delivery proofs with stock RNS 1.4.0 and preserved loss exit 2"
