...
SERVER="$ROOT/prns-core/tests/interop/rns_rnid_network_server.py"
WORK="$(mktemp -d)"
CONFIG="$WORK/config"
...
echo "PASS: Prnsd id resolved and announced identities through a stock RNS 1.3.8 shared instance"
