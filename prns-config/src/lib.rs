...
pub use plan::{
    ...
    RNodeMultiDevicePlan, RNodeMultiMemberPlan, ReadyCommandFlowControl, ReconnectLimit,
    SerialDataBits, SerialLinePlan, SerialParity, SerialStopBits, SharedInstance,
